<div class="sharers" data-title="<?php echo get_the_title($post->ID);?>">
			...
			<a class="share-link whatsapp" data-base="whatsapp://send?text="><i class="fa fa-whatsapp"></i></a>
			<a class="share-link telegram" data-base="g://msg?text="><i class="fa fa-telegram"></i></a>
		</div>